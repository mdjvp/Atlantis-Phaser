...
GamePlayManager = {
    ...
    preload: function() {
        ...
        game.load.spritesheet('horse', 'assets/images/horse.png', 84, 156, 2); //(width, height, cant de imagenes contenidas)
    ...
    create: function() {
        ...
        this.horse.anchor.setTo(0.5); //punto de referencia
    ...
    //obtener limites del rectangulo
    ...
    isOverlappingOtherDiamond:function(index, rect2){ //compara cada elemento del array con los datos del currentDiamond recibido
